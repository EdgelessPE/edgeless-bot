import { ScraperRegister } from "@/types/class";
...
const regArray: Array<ScraperRegister> = [
  ...
  },
  {
    ...
    requiredKeys: [],
    description:
      'Use given regex to match text in html file, narrow the scope by specify jQuery selector in "scraper_temp.download_selector" "scraper_temp.version_selector"',
  },
  {
    name: "REST API",
    entrance: "REST_API",
