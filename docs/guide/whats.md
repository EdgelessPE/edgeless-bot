...
克隆此仓库并执行 `pnpm install && pnpm dev` 即可快速开始，详情请见[安装与使用](usage.md)。
...
下方的流程图大致描述了 Edgeless Bot 的工作流程，其中蓝色的部分是 Edgeless Bot 本体提供的功能，棕色部分是 Edgeless Bot 在运行过程中动态生成、维护的部分，其他部分由模板提供。

![](https://cloud.edgeless.top/picbed/bot/bot-next.png)
